...
//     if (!currentPageHeightPx || !autoPaginateEnabled) return;
...
//             const hasBreak = prev && prev.is('element', 'pageBreak');

//             if (
//                 usedHeight + height > currentPageHeightPx &&
//                 !hasBreak
//             ) {
//                 writer.insertElement('pageBreak', child, 'before');
//                 usedHeight = 0;
//                 continue;
//             }
